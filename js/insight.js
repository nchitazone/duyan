...
(function ($, CONFIG) {
    ...
    function search (json, keywords) {
        ...
        return {
            ...
            pages: pages.filter(FILTERS.PAGE).sort(function (a, b) { return WEIGHTS.PAGE(b) - WEIGHTS.PAGE(a); }).slice(4, 20),
    ...
    function searchResultToDOM (searchResult) {
        ...
        for (var key in searchResult) {
            if (key=="pages")
            {
                for(i=0;i<(searchResult['pages'].length);i++)
                {
                    if (searchResult['pages'][i]['title']=="404 Page Not Found"){
                         //searchResult['pages'].shift();  
                         searchResult['pages'].splice(i,1);
                     };
